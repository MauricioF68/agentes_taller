                    ...
                    <div className="w-full md:w-2/3 p-6 overflow-y-auto flex flex-col justify-between">
                        {!activeGroup ? (
                            ...
                            <div className="space-y-6 flex-1 flex flex-col justify-between">
                                ...
                                <form onSubmit={submitEvaluation} className="border-t border-gray-100 pt-5 mt-auto">
                                    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
                                        <div className="sm:col-span-1">
                                            <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Nota (0 - 20)</label>
                                            <NotionInput 
                                                type="number" 
                                                min="0" 
                                                max="20" 
                                                ...
                                                onChange={(e) => setEvalData('score', e.target.value)} 
                                                required 
                                                className="w-full text-xl font-bold text-center h-11" 
                                                placeholder="0.0" 
                                            />
                                            {evalErrors.score && <div className="text-red-500 text-xs mt-1">{evalErrors.score}</div>}
                                        </div>
                                        <div className="sm:col-span-3">
                                            <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Veredicto de la Auditoría / Feedback</label>
                                            <textarea 
                                                className="w-full bg-notion-bg border-notion-border text-notion-text focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-md shadow-sm h-11 resize-none pt-2.5 px-3 text-xs" 
                                    ...
                                    <div className="flex justify-end gap-3 pt-4 mt-4 border-t border-gray-50">
                                        ...
                                        <NotionButton variant="primary" type="submit" disabled={processingEval || !evalData.score}>
