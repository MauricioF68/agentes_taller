...
export default function VoiceToTextButton({ onTranscription, className = 'w-8 h-8', iconClassName = 'w-4 h-4' }) {
    ...
    return (
        ...
        >
            {isProcessing ? (
                <svg className={`animate-spin ${iconClassName}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
